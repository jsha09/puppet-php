  ...
  case $::osfamily {
    ...
    'RedHat': {
      case $php::globals::rhscl_mode {
        'remi': {
          $config_root_ini         = "${php::globals::globals_config_root}/php.d"
          $config_root_inifile     = "${php::globals::globals_config_root}/php.ini"
          $cli_inifile             = $config_root_inifile
          $fpm_inifile             = $config_root_inifile
          $fpm_config_file         = "${php::globals::globals_config_root}/php-fpm.conf"
          $fpm_pool_dir            = "${php::globals::globals_config_root}/php-fpm.d"
        ...
        'rhscl': {
          $config_root_ini         = "${php::globals::globals_config_root}/php.d"
          $config_root_inifile     = "${php::globals::globals_config_root}/php.ini"
          $cli_inifile             = "${php::globals::globals_config_root}/php-cli.ini"
          $fpm_inifile             = "${php::globals::globals_config_root}/php-fpm.ini"
          $fpm_config_file         = "${php::globals::globals_config_root}/php-fpm.conf"
          $fpm_pool_dir            = "${php::globals::globals_config_root}/php-fpm.d"
          $php_bin_dir             = "${php::globals::rhscl_root}/bin"
        }
        undef: {
          $config_root_ini         = $php::globals::globals_config_root
